...
type PropertyBathsPopoverProps = {
  value: string
...
export function PropertyBathsPopover({
  value,
  onValueChange,
}: PropertyBathsPopoverProps) {
  const activeLabel =
    bathSteps.find((option) => option.value === value)?.label ?? "Baths"
